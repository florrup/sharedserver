...
var TripsPage = function (_Component) {
  _inherits(TripsPage, _Component);

  function TripsPage(props) {
    _classCallCheck(this, TripsPage);

    var _this = _possibleConstructorReturn(this, (TripsPage.__proto__ || Object.getPrototypeOf(TripsPage)).call(this, props));
  ...
  _createClass(TripsPage, [{
    ...
    value: function getTrips() {
      ...
      return _axios2.default.get(path + '/api/trips', axiosHeader).then(function (response) {
        console.log(response.data);
        //console.log('Metadata' + response.data.metadata);
        _this2.setState({ trips: response.data.trips });
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_components.Banner, { title: 'Viajes realizados', subtitle: 'Listado de viajes realizados con Llevame!' }),
            _react2.default.createElement(_components.TripsList, { header: tableHeader, trips: trips })
          )
        ),
        _react2.default.createElement(
          'div',
...
_reactDom2.default.render(_react2.default.createElement(TripsPage, null), document.getElementById('tripspage'));

/***/ })
/******/ ]);
//# sourceMappingURL=tripspage.bundle.map