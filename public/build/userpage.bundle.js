...
var UsersPage = function (_Component) {
  ...
  _createClass(UsersPage, [{
    ...
    value: function getPeople() {
      ...
      return _axios2.default.get(path + '/api/users', axiosHeader).then(function (response) {
        console.log(response.data);
        //console.log('Metadata' + response.data.metadata);
        //console.log('Users' + response.data.users);
        _this2.setState({ people: response.data.users });
    ...
    value: function render() {
      ...
      var filteredUsers = this.state.people.filter(function (user) {
        return user.username.toLowerCase().indexOf(_this3.state.search.toLowerCase()) !== -1;
      });
      return _react2.default.createElement(
        'div',
        { id: 'wrapper' },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_components.Banner, { title: 'Usuarios de aplicaci\xF3n', subtitle: 'Usuarios que utilizan Llevame!' }),
            _react2.default.createElement(_components.UserList, { header: tableHeader, people: filteredUsers }),
            _react2.default.createElement(
              'label',
              null,
...
_reactDom2.default.render(_react2.default.createElement(UsersPage, null), document.getElementById('userspage'));

/***/ })
/******/ ]);
//# sourceMappingURL=userpage.bundle.map